...
var Button = function Button(_ref) {
  ...
  if (loading) {
    Icon = function Icon() {
      return /*#__PURE__*/React.createElement(BsArrowRepeat, {
        style: {
          fil: 'white'
        },
...
var Alert = function Alert(_ref7) {
  ...
  if (type === 'success') {
    Icon = function Icon() {
      return /*#__PURE__*/React.createElement(BsCheckCircle, {
        style: {
          width: 24,
          height: 24,
          fill: '#24B9E1'
...
var Modal = function Modal(_ref9) {
  ...
  if (visibility === true) {
    render = /*#__PURE__*/React.createElement("div", {
      ...
      className: closeButton !== false ? style['header-padding'] : style['header']
...
export { Alert, Banner, Button, ButtonCircle, CheckBox, Confirm, Input, InputArea, MobileHeader, Modal, Radio };
